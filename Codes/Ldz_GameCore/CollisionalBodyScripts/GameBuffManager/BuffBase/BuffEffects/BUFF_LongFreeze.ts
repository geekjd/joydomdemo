...
/**长时间冻结 */
export default class BUFF_LongFreeze extends BuffBase {
    ...
    InitBuffBase(_SoldiersBase: any, TempDamageData: any) {
        ...
        let Temp: _HeroBuffConfig.DataType = HeroBuffDataProxy.instance.GetBuffInfoByEnglishName("BUFF_LongFreeze");
