...
/**持续狂暴 */
export default class BUFF_ExtendRage extends BuffBase {
    ...
    InitBuffBase(_SoldiersBase: any, TempDamageData: any) {
        ...
        let Temp: _HeroBuffConfig.DataType = HeroBuffDataProxy.instance.GetBuffInfoByEnglishName("BUFF_ExtendRage");
