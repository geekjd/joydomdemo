...
import { BarbarianStateManager } from "src/Ldz_GameCore/FSM_Animation/Enity/EnityAnimationManager/BarbarianStateManager";
...
/**野蛮人 */
export default class Barbarian extends MagicCubeSource {


    Init(Lv: number = 1) {
        this.MagicName = "Barbarian";
        this.m_Enitiy = Enitiy.Role_Type;
        super.Init(Lv);
    }
    onAwake() {
        super.onAwake();
        this.m_AnimatorManager = new BarbarianStateManager();
