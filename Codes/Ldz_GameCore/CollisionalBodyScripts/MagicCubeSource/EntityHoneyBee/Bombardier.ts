...
import { BombardierStateManager } from "src/Ldz_GameCore/FSM_Animation/Enity/EnityAnimationManager/BombardierStateManager";
...
/**炸弹人 */
export default class Bombardier extends MagicCubeSource {


    Init(Lv: number = 1) {
        this.MagicName = "Bombardier";
        this.m_Enitiy = Enitiy.Role_Type;
        super.Init(Lv);
    }
    onAwake() {
        super.onAwake();
        this.m_AnimatorManager = new BombardierStateManager();
