...
import { ElfArcherStateManager } from "src/Ldz_GameCore/FSM_Animation/Enity/EnityAnimationManager/ElfArcherStateManager";
...
export default class ElfArcher extends MagicCubeSource {

    Init(Lv: number = 1) {
        this.MagicName = "ElfArcher";
        this.m_Enitiy = Enitiy.Role_Type;
        super.Init(Lv);
        console.log("远程人物距离", this.m_AttributeBase.m_Range);
    }
    onAwake() {
        super.onAwake();
        this.m_AnimatorManager = new ElfArcherStateManager();
