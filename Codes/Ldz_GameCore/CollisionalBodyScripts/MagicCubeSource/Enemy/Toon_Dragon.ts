...
/**喷火龙 */
export default class Toon_Dragon extends MagicCubeSource {


    Init(Lv: number = 1) {
        this.MagicName = "Toon_Dragon";
    ...
    AttackTarget(_TargetObj: Laya.Sprite3D): boolean {
        if (this.m_AttributeBase.m_Projectiles != "") {
            ...
            MesManager.event(ESceneEvent.ReleaseSkills, [200001, this.m_DamageData.Clone()])
        } else {
