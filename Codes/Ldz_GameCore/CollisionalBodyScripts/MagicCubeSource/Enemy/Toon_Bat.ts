...
import { Enitiy, EntityState, WorkType } from "src/Ldz_GameCore/GeneralScripts/GameDefine";
...
/**石像蝙蝠 */
export default class Toon_Bat extends MagicCubeSource {


    Init(Lv: number = 1) {
        this.MagicName = "Toon_Bat";
