import { EntityState, GameBigSwordAnimationDefin } from "src/Ldz_GameCore/GeneralScripts/GameDefine";
import CombatantManageBase from "../../../FSM_Base/CombatantManageBase";
import CombatantStateBase from "../../../FSM_Base/CombatantStateBase";



export default class BigSwordStateAttack2 extends CombatantStateBase {
    ...
    public Init(SelfObj: Laya.Sprite3D, _CombatantManageBase: CombatantManageBase)                  //初始化虚函数
    {
        ...
        this.m_EntityState = EntityState.AttackTwo;
    }
    public OnEnter()               //进入状态的虚函数
    {
        ...
        this.PlayAnimation(GameBigSwordAnimationDefin.AnimationName_THSwordMeleeAttack02);
    ...
    {
        //当前状态不是 这个脚本的时候 就退出
        if ((this.m_StateManage.m_CurStateBase.m_EntityState != EntityState.AttackTwo)) {
            return;
        }
