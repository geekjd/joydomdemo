...
export default class GeneralStateRun extends CombatantStateBase {
    ...
    {
        //this.m_StateManage.m_Attackinterval = this.m_StateManage.m_MagicCubeSource.m_TempAttributeBase.m_HitSpeed / 2;
        super.OnExit();
    }
