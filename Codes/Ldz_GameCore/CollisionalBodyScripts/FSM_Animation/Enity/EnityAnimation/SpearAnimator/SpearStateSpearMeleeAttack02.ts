...
export default class SpearStateSpearMeleeAttack02 extends CombatantStateBase {
    ...
    {
        this.PlayAnimation(GameSpearAnimationDefin.AnimationName_SpearMeleeAttack02);
