...
export default class SpearStateSpearMeleeAttack01 extends CombatantStateBase {
    ...
    {
        this.PlayAnimation(GameSpearAnimationDefin.AnimationName_SpearMeleeAttack01);
