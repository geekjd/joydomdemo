...
export default class FlightStateFlyLongbowShootAttack01 extends CombatantStateBase {
    ...
    {
        this.PlayAnimation(GameFlightAnimationDefin.AnimationName_FlyLongbowShootAttack01);
