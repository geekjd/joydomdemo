...
export default class FlightStateFlyCrossbowShootAttack extends CombatantStateBase {
    ...
    public OnEnter()               //进入状态的虚函数
    {
        ...
        this.PlayAnimation(GameFlightAnimationDefin.AnimationName_FlyCrossbowShootAttack);
