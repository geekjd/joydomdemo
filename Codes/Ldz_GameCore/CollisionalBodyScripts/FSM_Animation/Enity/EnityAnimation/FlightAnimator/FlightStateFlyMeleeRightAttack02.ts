...
export default class FlightStateFlyMeleeRightAttack02 extends CombatantStateBase {
    ...
    public OnEnter()               //进入状态的虚函数
    {
        ...
        this.PlayAnimation(GameFlightAnimationDefin.AnimationName_FlyMeleeRightAttack02);
