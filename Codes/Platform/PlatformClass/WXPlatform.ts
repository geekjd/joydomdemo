...
export default class WXPlatform implements IPlatform {
    ...
    protected loadFail: Laya.Handler;
    ...
    protected _CreateBannerAd() {
        ...
        //   bannerObj["adUnitId"] = '4gr6k32h08j7j9a72g'; // "";
        console.log('  自己改的 id@@', this.platformData.bannerId);
    ...
    protected _DoNoCacheShowVideo(onSuccess: Laya.Handler, onSkipped: Laya.Handler, loadFail: Laya.Handler) {
        this._rewardSuccessed = onSuccess;
        this._rewardSkipped = onSkipped;
    ...
    ShowRewardVideoAd(onSuccess: Laya.Handler, onSkipped: Laya.Handler, loadFail: Laya.Handler) {
        if (this._cacheVideoAD) {
            this._DoCacheShowVideo(onSuccess, onSkipped);
        } else {
            this._DoNoCacheShowVideo(onSuccess, onSkipped, loadFail);
        }
