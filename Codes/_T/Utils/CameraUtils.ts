...
export class CameraUtils {
    ...
    * @param ui 
    */
    private static LeftwordPos: Laya.Vector4 = new Laya.Vector4();
    public static GetPointFrom3DWorld2(camera: Laya.Camera, pos3d: Laya.Vector3, ui?: fgui.GObject): Laya.Point {
        let uiPos = this.LeftwordPos;
        camera.worldToViewportPoint(pos3d, uiPos);
        if (ui != null) {
            return ui.globalToLocal(uiPos.x, uiPos.y);
        } else {
