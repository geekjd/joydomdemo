...
export default class TimeUtils {
    ...
    */
    ...
    /**只取分钟值，不要秒 */
    public static makeTimeLeftShortString(time: number, separator: string = ":", flag: Boolean = false): string {
        var ret: string = "";
        var hour: number;
        if (time <= 0) {
            ret = ret + "00:00";
    ...
    * 获取当前天数
    */
    public static GetCurrentDayCount(tick: number): number {
