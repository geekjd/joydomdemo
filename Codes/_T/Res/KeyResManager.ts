...
export default class KeyResManager {
    ...
    private constructor() {
        ...
        //注册关键资源目录
        this.m_KeyResList = {
            //"https://file.quduoduodata.top/ossfile/laya/Hunt/v1/" +

            [EKeyResName.RootRes]: EKeyResName.RootRes + '/',
            // [EKeyResName.ConfigJson]: EKeyResName.HttpUrl + EKeyResName.RootRes + '/' + EKeyResName.ConfigJson + '/',
            [EKeyResName.ConfigJson]: EKeyResName.RootRes + '/' + EKeyResName.ConfigJson + '/',
            //  [EKeyResName.SceneJson]: EKeyResName.HttpUrl + EKeyResName.RootRes + '/' + EKeyResName.SceneJson + '/',
            [EKeyResName.SceneJson]: EKeyResName.RootRes + '/' + EKeyResName.SceneJson + '/',
            [EKeyResName.NavMeshConfigJson]: EKeyResName.RootRes + '/' + EKeyResName.NavMeshConfigJson + '/',

            [EKeyResName.FGUI]: EKeyResName.RootRes + '/' + EKeyResName.FGUI + '/',
            [EKeyResName.Font]: EKeyResName.HttpUrl + EKeyResName.RootRes + '/' + EKeyResName.Font + '/',
            [EKeyResName.Other]: EKeyResName.HttpUrl + EKeyResName.RootRes + '/' + EKeyResName.Other + '/',
            //其他路径
            [EKeyResName.icon]: EKeyResName.HttpUrl + EKeyResName.RootRes + '/' + EKeyResName.Other + '/' + EKeyResName.icon + '/',
            [EKeyResName.img]: EKeyResName.HttpUrl + EKeyResName.RootRes + '/' + EKeyResName.Other + '/' + EKeyResName.img + '/',
            [EKeyResName.music]: EKeyResName.HttpUrl + EKeyResName.RootRes + '/' + EKeyResName.Other + '/' + EKeyResName.music + '/',
            [EKeyResName.sound]: EKeyResName.HttpUrl + EKeyResName.RootRes + '/' + EKeyResName.Other + '/' + EKeyResName.sound + '/',
            [EKeyResName.skin]: EKeyResName.HttpUrl + EKeyResName.RootRes + '/' + EKeyResName.Other + '/' + EKeyResName.skin + '/',
            [EKeyResName.FGUIMain]: "ui://GameMain" + "/",
        };
        // console.log(this.m_KeyResList);
        //   [EKeyResName.RootRes]: "https://file.quduoduodata.top/ossfile/laya/Hunt/v1/" + EKeyResName.RootRes + '/',
    };
