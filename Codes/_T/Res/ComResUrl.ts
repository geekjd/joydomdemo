...
export default class ComResUrl {
    ...
    /**
  * FGUI GameMain包下的资源路径
  * @param name 图标名称 
  */
    public static MainFgui_url(name: string): string {
        return KeyResManager.getResURL(EKeyResName.FGUIMain) + name;
    }
}