...
export default class GlobalD3Environment {
    ...
    public static init() {
        ...
        this.m_Light.color = new Laya.Vector3(255 / 255, 255 / 255, 255 / 255);
        this.m_Light.intensity = 1;
        this.m_Light.shadowMode = Laya.ShadowMode.SoftHigh;
        // this.m_Light.shadowStrength = 1.2;
        this.m_Light.shadowResolution = 2048;
        this.m_Scene3D.addChild(this.m_Camera);
        this.m_Scene3D.addChild(this.m_Light);
        this.m_Scene3D.ambientColor = new Laya.Vector3(97 / 255, 97 / 255, 97 / 255);
    }
